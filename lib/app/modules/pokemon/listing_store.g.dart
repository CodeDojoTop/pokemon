...
mixin _$ListingStore on _ListingStoreBase, Store {
  final _$valueAtom = Atom(name: '_ListingStoreBase.value');
  ...
  final _$_ListingStoreBaseActionController =
      ActionController(name: '_ListingStoreBase');

  @override
  void increment() {
    final _$actionInfo = _$_ListingStoreBaseActionController.startAction(
        name: '_ListingStoreBase.increment');
    try {
